...
export const hsk34Dialogues: FallbackDialogue[] = [
  ...
  },
  {
    ...
    sceneEmoji: "🔒",
    lines: [
    { speaker: "A", chinese: "请把行李放上去，请把外套脱掉。", pinyin: "Qǐng bǎ xíng li fàng shàng qu , qǐng bǎ wài tào tuō diào .", japanese: "荷物はベルトの上に乗せてください。上着も脱いでください。" },
    { speaker: "B", chinese: "好的，请问雨伞也要单独检查吗？", pinyin: "Hǎo de , qǐng wèn yǔ sǎn yě yào dān dú jiǎn chá ma ?", japanese: "はい、傘も一人で検査する必要がありますか？" },
    { speaker: "A", chinese: "对，雨伞和电脑都要单独过机器。", pinyin: "Duì , yǔ sǎn hé diàn nǎo dōu yào dān dú guò jī qì .", japanese: "はい、傘もパソコンも一台ずつ機械に通してください。" },
    { speaker: "B", chinese: "好的，我的充电宝是一万毫安的。", pinyin: "Hǎo de , wǒ de chōng diàn bǎo shì yí wàn háo ān de .", japanese: "はい、私のモバイルバッテリーは10000ミリアンペアです。" },
    { speaker: "A", chinese: "一万毫安可以带上去，但是不能托运。", pinyin: "Yí wàn háo ān kě yǐ dài shàng qu , dàn shì bù néng tuō yùn .", japanese: "10000ミリアンペアなら機内持込は可能です。ただし預けられません。" },
    { speaker: "B", chinese: "我知道了。请问液体有限制吗？", pinyin: "Wǒ zhī dào le . Qǐng wèn yè tǐ yǒu xiàn zhì ma ?", japanese: "わかりました。液体には制限がありますか？" },
    { speaker: "A", chinese: "每位乘客只能带一件不超过一百毫升的液体。", pinyin: "Měi wèi chéng kè zhǐ néng dài yí jiàn bù chāo guò yì bǎi háo shēng de yè tǐ .", japanese: "乗客お一人様、一容器100ミリリットル以内の液体のみ持込可能です。" },
    { speaker: "B", chinese: "请问这瓶香水可以带吗？", pinyin: "Qǐng wèn zhè píng xiāng shuǐ kě yǐ dài ma ?", japanese: "この香水は持込めますか？" },
    { speaker: "A", chinese: "一百毫升以上需要托运，请配合。", pinyin: "Yì bǎi háo shēng yǐ shàng xū yào tuō yùn , qǐng pèi hé .", japanese: "100ミリリットル以上の場合は預けが必要です。ご協力をお願いします。" },
    { speaker: "B", chinese: "好的，我现在去托运，谢谢提醒。", pinyin: "Hǎo de , wǒ xiàn zài qù tuō yùn , xiè xie tí xǐng .", japanese: "わかりました。今預けに行きます。ありがとうごございます。" }
    ],
    keyVocabulary: [
      { word: "安检", pinyin: "ān jiǎn", meaning: "保安検査（Security Check）", usageNote: "「安全検査」の略。入国審査（税関）とは別物" },
      { word: "充电宝", pinyin: "chōng diàn bǎo", meaning: "モバイルバッテリー（便携式充电器）", usageNote: "中国民航局规定：100Wh以下可随身携带，100-160Wh需航空公司批准" },
      { word: "托运", pinyin: "tuō yùn", meaning: "預ける（受託手荷物）", writingNote: "中文说「托运」「办托运」，日语说「預ける」「受託手荷物」" },
      { word: "液体", pinyin: "yè tǐ", meaning: "液体", writingNote: "中日同形語（異音同形）、意味も同じ" },
      { word: "毫升", pinyin: "háo shēng", meaning: "ミリリットル（ml）", usageNote: "中国ではccではなく毫升。航空液体制限は100ml容器×1L袋" },
      { word: "毫安", pinyin: "háo ān", meaning: "ミリアンペア（mAh）", usageNote: "バッテリー容量単位。航空規則はWh（ワット時）で計算される" },
      { word: "雨伞", pinyin: "yǔ sǎn", meaning: "傘（傘を指す）", writingNote: "中文「伞」= 日本語「傘」。形状により折傘・長傘区別なし" },
      { word: "机器", pinyin: "jī qì", meaning: "機械・装置", writingNote: "「机器」= machine。日语「機械」に近いがより日常的" }
    ],
  },
  {
    scene: "登机口",
    ...
    sceneEmoji: "🛫",
    lines: [
    { speaker: "A", chinese: "您好，请问这是去东京的航班吗？", pinyin: "Nín hǎo , qǐng wèn zhè shì qù Dōngjīng de háng bān ma ?", japanese: "失礼いたしますが、これは東京行きの便ですか？" },
    { speaker: "B", chinese: "是的，请问您的登机牌准备好了吗？", pinyin: "Shì de , qǐng wèn nín de dēng jī pái zhǔn bèi hǎo le ma ?", japanese: "はい、搭乗券はお 준비できていますか？" },
    { speaker: "A", chinese: "给您看一下，我的航班延误了一个小时。", pinyin: "Gěi nín kàn yí xià , wǒ de háng bān yán wù le yí gè xiǎo shí .", japanese: "はい、これですが、便が1時間遅延しているということです。" },
    { speaker: "B", chinese: "是的，由于天气原因，飞机会晚点起飞。", pinyin: "Shì de , yóu yú tiān qì yuán yīn , fēi jī huì wǎn diǎn qǐ fēi .", japanese: "はい、天候の関係で飞机的出発が遅れています。" },
    { speaker: "A", chinese: "请问现在可以在候机室等吗？", pinyin: "Qǐng wèn xiàn zài kě yǐ zài hòu jī shì děng ma ?", japanese: "搭乗待合室で待ってもよろしいですか？" },
    { speaker: "B", chinese: "可以，请在登机口附近等候，登机时间是十一点整。", pinyin: "Kě yǐ , qǐng zài dēng jī kǒu fù jìn děng hòu , dēng jī shí jiān shì shí yī diǎn zhěng .", japanese: "はい、搭乗ゲート付近でお待ちください。搭乗は11時です。" },
    { speaker: "A", chinese: "请问可以在候机室充电吗？", pinyin: "Qǐng wèn kě yǐ zài hòu jī shì chōng diàn ma ?", japanese: "待合室で充電できますか？" },
    { speaker: "B", chinese: "可以的，每个座位附近都有USB接口。", pinyin: "Kě yǐ de , měi gè zuò wèi fù jìn dōu yǒu USB jiē kǒu .", japanese: "はい、各座席の近くにUSB端子がございます。" },
    { speaker: "A", chinese: "太好了，请问有免费的Wi-Fi吗？", pinyin: "Tài hǎo le , qǐng wèn yǒu miǎn fèi de Wi-Fi ma ?", japanese: "ありがとうございます。無料のWi-Fiはありますか？" },
    { speaker: "B", chinese: "有，请连接Airport-Free-WiFi，输入手机号验证。", pinyin: "Yǒu , qǐng lián jiē Airport-Free-WiFi , shū rù shǒu jī hào yàn zhèng .", japanese: "はい、「Airport-Free-WiFi」に接続し、携帯番号で認証してください。" },
    { speaker: "A", chinese: "好的，谢谢您！我先去候机室等广播。", pinyin: "Hǎo de , xiè xie nín ! Wǒ xiān qù hòu jī shì děng guǎng bō .", japanese: "わかりました。ありがとうございます。じゃあ、待合室で放送を待ちます。" },
    { speaker: "B", chinese: "不客气，祝您旅途愉快。", pinyin: "Bú kè qi , zhù nín lǚ tú yú kuài .", japanese: "どういたしまして。ご旅行をお楽しみください。" }
    ],
    keyVocabulary: [
      { word: "登机口", pinyin: "dēng jī kǒu", meaning: "搭乗ゲート", writingNote: "中文「登机口」、日文「搭乗ゲート」。_gate的不同表达" },
      { word: "延误", pinyin: "yán wù", meaning: "遅延（する）", usageNote: "「延误」= 延迟＋耽误。航班/列车延误是中国常见情况" },
      { word: "定刻", pinyin: "dìng kè", meaning: "定刻・予定時刻", writingNote: "中文「定刻」= scheduled time。日文「定刻」=定刻運行" },
      { word: "候机室", pinyin: "hòu jī shì", meaning: "搭乗待合室", writingNote: "中文「候机」= 搭乗を待つ。日文「候」= 待つ（書き言葉）" },
      { word: "USB接口", pinyin: "USB jiē kǒu", meaning: "USB端子", writingNote: "中文「接口」= connection port。日文「端子」" },
      { word: "验证", pinyin: "yàn zhèng", meaning: "認証する", writingNote: "中文「验证」比日文「検証」更侧重身份/信息确认" },
      { word: "广播", pinyin: "guǎng bō", meaning: "放送・案内", usageNote: "机场广播很重要。「请注意」= お知らせがあります" },
      { word: "Wi-Fi", pinyin: "Wi-Fi", meaning: "Wi-Fi（ワイヤレスネットワーク）", writingNote: "外来语，中国也说「Wi-Fi」或「无线网」" }
    ],
  },
  {
    scene: "机上服务",
    ...
    sceneEmoji: "🛋️",
    lines: [
    { speaker: "A", chinese: "你好，请给我一条毛毯，有点冷。", pinyin: "Nǐ hǎo , qǐng gěi wǒ yì tiáo máo tǎn , yǒu diǎn lěng .", japanese: "すみません、毛布をいただけますか？少し寒いです。" },
    { speaker: "B", chinese: "好的，请稍等，请问您要喝点什么？", pinyin: "Hǎo de , qǐng shāo děng , qǐng wèn nín yào hē diǎn shén me ?", japanese: "はい、少々お待ちください。お飲み物は何にしますか？" },
    { speaker: "A", chinese: "请给我一杯橙汁，谢谢。", pinyin: "Qǐng gěi wǒ yì bēi chéng zhī , xiè xie .", japanese: "オレンジジュースをお願いします。" },
    { speaker: "B", chinese: "好的，橙汁没有了，只有苹果汁和矿泉水。", pinyin: "Hǎo de , chéng zhī méi yǒu le , zhǐ yǒu píng guǒ zhī hé kuàng quán shuǐ .", japanese: "はい、オレンジジュースは切れしております。りんごジュースとお水ですが。" },
    { speaker: "A", chinese: "那就苹果汁吧，请问有耳机吗？", pinyin: "Nà jiù píng guǒ zhī ba , qǐng wèn yǒu ěr jī ma ?", japanese: "じゃあ、りんごジュースでお願いします。ヘッドホンはありますか？" },
    { speaker: "B", chinese: "有，请插在扶手上的耳机孔里，娱乐系统是免费的。", pinyin: "Yǒu , qǐng chā zài fú shǒu shàng de ěr jī kǒng lǐ , yú lè xì tǒng shì miǎn fèi de .", japanese: "はい、アームレストのジャックに差し込んでください。エンターテイメントは 무료입니다。" },
    { speaker: "A", chinese: "请问怎么填写入境卡？", pinyin: "Qǐng wèn zěn me tián xiě rù jìng kǎ ?", japanese: "入国カードはどのように記入すればいいですか？" },
    { speaker: "B", chinese: "请写好您的姓名、护照号码和住宿地址。", pinyin: "Qǐng xiě hǎo nín de xìng míng , hù zhào hào mǎ hé zhù sù dì zhǐ .", japanese: "お名前、パスポート番号、現地の宿泊先をご記入ください。" },
    { speaker: "A", chinese: "住宿地址写酒店名称可以吗？", pinyin: "Zhù sù dì zhǐ xiě jiǔ diàn míng chēng kě yǐ ma ?", japanese: "宿泊先はホテルの名前でよろしいですか？" },
    { speaker: "B", chinese: "可以，入境卡会在降落前收走，请保管好护照。", pinyin: "Kě yǐ , rù jìng kǎ huì zài jiàng luò qián shōu zǒu , qǐng bǎo guǎn hǎo hù zhào .", japanese: "はい、着陸前に回収いたします。パスポートは大切に保管してください。" },
    { speaker: "A", chinese: "好的，谢谢！请问还有多久到达？", pinyin: "Hǎo de , xiè xie ! Qǐng wèn hái yǒu duō jiǔ dào dá ?", japanese: "ありがとうございます。あとどのくらいで着きますか？" },
    { speaker: "B", chinese: "还有两个小时，预计当地时间下午三点落地。", pinyin: "Hái yǒu liǎng gè xiǎo shí , yù jì dāng dì shí jiān xià wǔ sān diǎn luò dì .", japanese: "あと2時間で、現地の午後3時に着く見込みです。" }
    ],
    keyVocabulary: [
      { word: "毛毯", pinyin: "máo tǎn", meaning: "毛布", writingNote: "中文「毯」= 日文「毯」。毛毯/地毯/床毯区别使用" },
      { word: "耳机孔", pinyin: "ěr jī kǒng", meaning: "ヘッドホンジャック", writingNote: "中文「孔」= 穴・差し込み口。日文「ジャック」" },
      { word: "娱乐系统", pinyin: "yú lè xì tǒng", meaning: "機内エンターテイメント", usageNote: "中国航班多为IFE（In-Flight Entertainment）触控屏" },
      { word: "入境卡", pinyin: "rù jìng kǎ", meaning: "入国カード", writingNote: "中文「入境」= entering a country。日文「入国」（同義）" },
      { word: "护照号码", pinyin: "hù zhào hào mǎ", meaning: "パスポート番号", writingNote: "中国护照E开头8位。日本护照AB开头7位" },
      { word: "住宿地址", pinyin: "zhù sù dì zhǐ", meaning: "宿泊先", writingNote: "中文「住宿」= 滞在する。日文「宿泊」（同義漢語）" },
      { word: "降落", pinyin: "jiàng luò", meaning: "着陸する", writingNote: "中文「降落」= 日文「着陸」（同義）。「落」字に注意" },
      { word: "当地时间", pinyin: "dāng dì shí jiān", meaning: "現地時間", writingNote: "中日同形語。国際線では時差計算が重要" }
    ],
  },
  {
    scene: "海关入境",
    ...
    sceneEmoji: "🏛️",
    lines: [
    { speaker: "A", chinese: "你好，请出示您的护照和签证。", pinyin: "Nǐ hǎo , qǐng chū shì nín de hù zhào hé qiān zhèng .", japanese: "パスポートとビザを見せていただけますか。" },
    { speaker: "B", chinese: "给您，这是我的护照，签证是旅游签证。", pinyin: "Gěi nín , zhè shì wǒ de hù zhào , qiān zhèng shì lǚ yóu qiān zhèng .", japanese: "はい、パスポートです。ビザは観光ビザです。" },
    { speaker: "A", chinese: "请问您计划在中国停留多长时间？", pinyin: "Qǐng wèn nín jì huà zài Zhōngguó tíng liú duō cháng shí jiān ?", japanese: "中国での滞在期間はどのくらいですか？" },
    { speaker: "B", chinese: "计划停留十五天，住宿已经订好了。", pinyin: "Jì huà tíng liú shí wǔ tiān , zhù sù yǐ jīng dìng hǎo le .", japanese: "15日間滞在予定です。宿も予約済みです。" },
    { speaker: "A", chinese: "请出示您的住宿预订确认单。", pinyin: "Qǐng chū shì nín de zhù sù yù dìng què rèn dān .", japanese: "宿泊予約確認書を見せていただけますか？" },
    { speaker: "B", chinese: "在这里，但是我还没有打印，可以用手机显示吗？", pinyin: "Zài zhè lǐ , dàn shì wǒ hái méi yǒu dǎ yìn , kě yǐ yòng shǒu jī xiǎn shì ma ?", japanese: "ここですが、印刷していません。スマホで表示でもいいですか？" },
    { speaker: "A", chinese: "可以，请打开手机。请问您的职业是什么？", pinyin: "Kě yǐ , qǐng dǎ kāi shǒu jī . Qǐng wèn nín de zhí yè shì shén me ?", japanese: "はい、スマホを見せてください。お仕事はなんですか？" },
    { speaker: "B", chinese: "我是公司职员，这次是出差顺便旅游。", pinyin: "Wǒ shì gōng sī zhí yuán , zhè cì shì chū chāi shùn biàn lǚ yóu .", japanese: "企業の社員です。出張の合間に観光 тожеします。" },
    { speaker: "A", chinese: "好的，请录一下指纹，按双手拇指。", pinyin: "Hǎo de , qǐng lù yí xià zhǐ wén , àn shuāng shǒu mǔ zhǐ .", japanese: "はい、指紋を録してください。両手の親指をお願いします。" },
    { speaker: "B", chinese: "好的，请问我的签证可以延期吗？", pinyin: "Hǎo de , qǐng wèn wǒ de qiān zhèng kě yǐ yán qī ma ?", japanese: "はい、ビザの延長は可能ですか？" },
    { speaker: "A", chinese: "可以延期，最多三十天，请提前三天去出入境管理局办理。", pinyin: "Kě yǐ yán qī , zuì duō sān shí tiān , qǐng tí qián sān tiān qù chū rù jìng guǎn lǐ jú bàn lǐ .", japanese: "はい、最大30日間延長可能です。3日前に出入国管理局でお手続きください。" },
    { speaker: "B", chinese: "明白了，谢谢！欢迎来到中国，祝您旅途愉快。", pinyin: "Míng bái le , xiè xie ! Huān yíng lái dào Zhōngguó , zhù nín lǚ tú yú kuài .", japanese: "わかりました。ありがとうございます。中国へようこそ！ご旅行をお楽しみください。" }
    ],
    keyVocabulary: [
      { word: "签证", pinyin: "qiān zhèng", meaning: "ビザ", writingNote: "中文「签证」、日文「VISA」或「査証」。H5旅游签证（L visa）" },
      { word: "停留", pinyin: "tíng liú", meaning: "滞在する", writingNote: "中文「停留」= 一時的に留まる。日文「滞在」（同義）" },
      { word: "住宿预订", pinyin: "zhù sù yù dìng", meaning: "宿泊予約", writingNote: "中文「预订」= 予約する。日文「予約」" },
      { word: "职业", pinyin: "zhí yè", meaning: "職種・仕事", writingNote: "中文「职业」= occupation。日文「職業」（同形語）" },
      { word: "出差", pinyin: "chū chāi", meaning: "出張", writingNote: "中文「出差」= 日文「出張」（同義）。ビジネス語でよく使う" },
      { word: "指纹", pinyin: "zhǐ wén", meaning: "指紋", writingNote: "中日同形語。左右親指同時錄紋是各国入境标配" },
      { word: "出入境管理局", pinyin: "chū rù jìng guǎn lǐ jú", meaning: "出入国管理局", writingNote: "中国出入入境管理局负责签证、居留许可等事务" },
      { word: "延期", pinyin: "yán qī", meaning: "延長する", writingNote: "中文「延期」= 日文「延期」（同形同義）" }
    ],
  },
  {
    scene: "行李提取",
    ...
    sceneEmoji: "🧳",
    lines: [
    { speaker: "A", chinese: "我的行李没有出来，请问行李转盘是哪个？", pinyin: "Wǒ de xíng li méi yǒu chū lái , qǐng wèn xíng li zhuǎn pán shì nǎ ge ?", japanese: "私の荷物が出てこないのですか。ターンテ이블はどこですか？" },
    { speaker: "B", chinese: "请看屏幕，您的航班行李在七号转盘。", pinyin: "Qǐng kàn píng mù , nín de háng bān xíng li zài qī hào zhuǎn pán .", japanese: "モニターをご確認ください。お便の荷物はターンテーブル7番です。" },
    { speaker: "A", chinese: "我已经去过了，七号转盘没有我的行李。", pinyin: "Wǒ yǐ jīng qù guò le , qī hào zhuǎn pán méi yǒu wǒ de xíng li .", japanese: "行ってきましたが、7番には私の荷物がありませんでした。" },
    { speaker: "B", chinese: "请问您的行李牌还在吗？让我查一下。", pinyin: "Qǐng wèn nín de xíng li pái hái zài ma ? Ràng wǒ chá yí xià .", japanese: "お手荷物タグはお持ちですか？確認させてください。" },
    { speaker: "A", chinese: "在这里，是CA1234号。", pinyin: "Zài zhè lǐ , shì CA yī èr sān sì hào .", japanese: "ここです。CA1234です。" },
    { speaker: "B", chinese: "系统显示您的行李已经上了传送带，请稍等，我去帮您查一下。", pinyin: "Xì tǒng xiǎn shì nín de xíng li yǐ jīng shàng le chuán sòng dài , qǐng shāo děng , wǒ qù bāng nín chá yí xià .", japanese: "システムでは既にベルトに流されていますが、少々お待ちください。確認して参ります。" },
    { speaker: "A", chinese: "好的，谢谢。我的行李是黑色的大箱子，上面有我的标签。", pinyin: "Hǎo de , xiè xie . Wǒ de xíng li shì hēi sè de dà xiāng zi , shàng miàn yǒu wǒ de biāo qiān .", japanese: "はい、ありがとう。黒い大きなスーツケースで、表にタグがついています。" },
    { speaker: "B", chinese: "找到了！您的行李被送到了行李分发室。", pinyin: "Zhǎo dào le ! Nín de xíng li bèi sòng dào le xíng li fēn fā shì .", japanese: "見つかりました！手荷物は荷物配付室に運ばれていました。" },
    { speaker: "A", chinese: "太好了，请问需要我一起去取吗？", pinyin: "Tài hǎo le , qǐng wèn xū yào wǒ yì qǐ qù qǔ ma ?", japanese: "よかった。私が一緒に取りに行く必要はありますか？" },
    { speaker: "B", chinese: "不用，请您在这里签字，我帮您取过来。", pinyin: "Bú yòng , qǐng nín zài zhè lǐ qiān zì , wǒ bāng nín qǔ guò lái .", japanese: "結構です。こちらに署名をお願いします。私が取って参ります。" },
    { speaker: "A", chinese: "非常感谢，请问行李有损坏吗？", pinyin: "Fēi cháng gǎn xiè , qǐng wèn xíng li yǒu sǔn huài ma ?", japanese: "ありがとうございます。荷物は損傷していませんか？" },
    { speaker: "B", chinese: "看起来完好，没有破损。请您检查一下。", pinyin: "Kàn qǐ lái wán hǎo , méi yǒu pò sǔn . Qǐng nín jiǎn chá yí xià .", japanese: "見たところ問題なさそうです。開けてご確認ください。" }
    ],
    keyVocabulary: [
      { word: "行李转盘", pinyin: "xíng li zhuǎn pán", meaning: "ターンテーブル（手荷物受取）", writingNote: "中文「转盘」= rotating platform。日文「ターンテーブル」（英借词）" },
      { word: "行李牌", pinyin: "xíng li pái", meaning: "手荷物タグ", writingNote: "check-in时贴在护照上的luggage tag-stub" },
      { word: "传送带", pinyin: "chuán sòng dài", meaning: "ベルトコンベア・物流ベルト", writingNote: "中文「传送带」= conveyor belt。日文「ベルト」（英借词）" },
      { word: "标签", pinyin: "biāo qiān", meaning: "タグ", writingNote: "中文「标签」= label/tag。日文「ラベル」或「札」" },
      { word: "行李分发室", pinyin: "xíng li fēn fā shì", meaning: "手荷物配付室", writingNote: "大型机场专設，负责晚到/错送行李的分拣房间" },
      { word: "完好", pinyin: "wán hǎo", meaning: "无损・完整", writingNote: "中文「完好」= 完全无损伤。日文「无损」（同義）" },
      { word: "破损", pinyin: "pò sǔn", meaning: "損傷・破损", writingNote: "中文「破损」= 壊れること。日文「損傷」" },
      { word: "签字", pinyin: "qiān zì", meaning: "署名する", writingNote: "中文「签字」= sign。日文「署名」（同義）" }
    ],
  },
  {
    scene: "高铁购票",
    ...
    sceneEmoji: "🚄",
    lines: [
    { speaker: "A", chinese: "你好，我要买两张明天去北京的高铁票，二等座。", pinyin: "Nǐ hǎo , wǒ yào mǎi liǎng zhāng míng tiān qù Běijīng de gāo tiě piào , èr děng zuò .", japanese: "こんにちは、明日の北京行きの新幹線チケットを2枚、二等席をお願いします。" },
    { speaker: "B", chinese: "好的，请问是早班车还是下午的车？", pinyin: "Hǎo de , qǐng wèn shì zǎo bān chē hái shì xià wǔ de chē ?", japanese: "はい、朝の便と午後便がありますが、どちらがよろしいですか？" },
    { speaker: "A", chinese: "下午三点的，请问有几等座？价格是多少？", pinyin: "Xià wǔ sān diǎn de , qǐng wèn yǒu jǐ děng zuò ? Jià gé shì duō shǎo ?", japanese: "午後3時の便をお願いします。座席の等級はありますか？おいくらですか？" },
    { speaker: "B", chinese: "有二等座、一等座和商务座。二等座每张五百五十元。", pinyin: "Yǒu èr děng zuò , yī děng zuò hé shāng wù zuò . Èr děng zuò měi zhāng wǔ bǎi wǔ shí yuán .", japanese: "二等席、一等席とビジネス席がございます。二等席は1枚550元です。" },
    { speaker: "A", chinese: "那就买两张二等座，请问可以用护照购票吗？", pinyin: "Nà jiù mǎi liǎng zhāng èr děng zuò , qǐng wèn kě yǐ yòng hù zhào gòu piào ma ?", japanese: "じゃあ2枚二等席でお願いします。パスポートでチケットを買えますか？" },
    { speaker: "B", chinese: "可以用护照，但是需要输入护照号码。", pinyin: "Kě yǐ yòng hù zhào , dàn shì xū yào shū rù hù zhào hào mǎ .", japanese: "はい、パスポートでお買い求めいただけますが、パスポート番号の入力が必要です。" },
    { speaker: "A", chinese: "好的，请问可以改签吗？万一赶不上。", pinyin: "Hǎo de , qǐng wèn kě yǐ gǎi qiān ma ? Wàn yī gǎn bù shàng .", japanese: "はい、変更は可能ですか？もしかして間に合わない場合がありまして。" },
    { speaker: "B", chinese: "开车前可以免费改签一次，需要加手续费每张二十元。", pinyin: "Kāi chē qián kě yǐ miǎn fèi gǎi qiān yí cì , xū yào jiā shǒu xù fèi měi zhāng èr shí yuán .", japanese: "出発前であれば1回無料変更できます。手数料として1枚20元の追加が必要です。" },
    { speaker: "A", chinese: "明白了，请问电子客票怎么进站？", pinyin: "Míng bái le , qǐng wèn diàn zǐ kè piào zěn me jìn zhàn ?", japanese: "わかりました。電子チケットでの入场方法は？" },
    { speaker: "B", chinese: "刷身份证进站就可以，报一下您的护照号码和手机号。", pinyin: "Shuā shēn fèn zhèng jìn zhàn jiù kě yǐ , bào yí xià nín de hù zhào hào mǎ hé shǒu jī hào .", japanese: "身分証明書で改札口をスキャンすれば入場できます。パスポート番号と携帯番号をお知らせください。" },
    { speaker: "A", chinese: "护照号码是E12345678，手机号是一三九开头的。", pinyin: "Hù zhào hào mǎ shì E yī èr sān sì wǔ liù qī bā , shǒu jī hào shì yī sān jiǔ kāi tóu de .", japanese: "パスポート番号はE12345678、携帯番号は139からです。" },
    { speaker: "B", chinese: "好的，请付款，一共是一千一百元。", pinyin: "Hǎo de , qǐng fù kuǎn , yí gòng shì yì qiān yì bǎi yuán .", japanese: "はい、お会計は合計1100元です。" }
    ],
    keyVocabulary: [
      { word: "高铁", pinyin: "gāo tiě", meaning: "新幹線（中国高速鉄道）", usageNote: "中国高铁CRH系列，最高时速350km/h。相当于日本新幹線" },
      { word: "二等座", pinyin: "èr děng zuò", meaning: "二等席", writingNote: "中国高铁座位等级：商务座 > 一等座 > 二等座" },
      { word: "改签", pinyin: "gǎi qiān", meaning: "チケット変更", usageNote: "中国高铁改签规则复杂：开车前可改签/退票，开车后不可退" },
      { word: "电子客票", pinyin: "diàn zǐ kè piào", meaning: "電子チケット（QR不要、身分证刷卡）", usageNote: "中国高铁全面电子化，护照+身份证= ticket。无需取票" },
      { word: "护照号码", pinyin: "hù zhào hào mǎ", meaning: "パスポート番号", writingNote: "中国护照E开头8位，外籍护照格式各异" },
      { word: "手续费", pinyin: "shǒu xù fèi", meaning: "手数料", writingNote: "中日同形語。改签手续费通常20-50元不等" },
      { word: "身份证", pinyin: "shēn fèn zhèng", meaning: "身分証明書（中国居民身分証）", usageNote: "中国公民乘高铁必须使用二代身份证刷卡进站" },
      { word: "开车", pinyin: "kāi chē", meaning: "出発する（列車の）", writingNote: "中文「开车」= drive/start car + 开车=列车出发。日文「出発」" }
    ],
  },
  {
    scene: "打车去机场",
    ...
    sceneEmoji: "🚕",
    lines: [
    { speaker: "A", chinese: "师傅，我去首都机场，三号航站楼，麻烦快一点。", pinyin: "Shī fu , wǒ qù Shǒu dū Jī chǎng , sān hào háng zhàn lóu , má fan kuài yì diǎn .", japanese: "ドライバーさん、首都空港の第3ターミナルまで行きたいです。急いでください。" },
    { speaker: "B", chinese: "好的，现在是早高峰，有点堵，我尽量绕一下。", pinyin: "Hǎo de , xiàn zài shì zǎo gāo fēng , yǒu diǎn dǔ , wǒ jǐn liàng rào yí xià .", japanese: "はい、今は朝のピークで少し込んでいます。できる限り遠回りします。" },
    { speaker: "A", chinese: "好的，请问大概多久能到？", pinyin: "Hǎo de , qǐng wèn dà gài duō jiǔ néng dào ?", japanese: "はい、どれくらいかかりそうですか？" },
    { speaker: "B", chinese: "大概五十分钟，如果不堵车的话可以快十分钟。", pinyin: "Dà gài wǔ shí fēn zhōng , rú guǒ bù dǔ chē de huà kě yǐ kuài shí fēn zhōng .", japanese: "おそらく50分程度です。込まなければ10分早いです。" },
    { speaker: "A", chinese: "好的，我有行李，麻烦开一下后备箱。", pinyin: "Hǎo de , wǒ yǒu xíng li , má fan kāi yí xià hòu bèi xiāng .", japanese: "はい、荷物があります。トランクを開けてもらえますか？" },
    { speaker: "B", chinese: "没问题，您有几个箱子？", pinyin: "Méi wèn tí , nín yǒu jǐ gè xiāng zi ?", japanese: "問題ありませんが、スーツケースはいくつですか？" },
    { speaker: "A", chinese: "两个箱子，后备箱应该够放。", pinyin: "Liǎng gè xiāng zi , hòu bèi xiāng yīng gāi gòu fàng .", japanese: "2個ありますが、トランクに入りますか？" },
    { speaker: "B", chinese: "够的，您系好安全带，我们准备出发了。", pinyin: "Gòu de , nín jì hǎo ān quán dài , wǒ men zhǔn bèi chū fā le .", japanese: "はい、Vベルトを締めてください。出発します。" },
    { speaker: "A", chinese: "好的，请问走机场高速还是普通路？", pinyin: "Hǎo de , qǐng wèn zǒu jī chǎng gāo sù hái shì pǔ tōng lù ?", japanese: "はい、空港高速道路と一般道、どちらを行きますか？" },
    { speaker: "B", chinese: "走高速快一些，但是要收十块钱高速费。", pinyin: "Zǒu gāo sù kuài yì xiē , dàn shì yào shōu shí kuài qián gāo sù fèi .", japanese: "高速道路の方が速いですが、高速料金として10元必要です。" },
    { speaker: "A", chinese: "走高速吧，时间更重要。", pinyin: "Zǒu gāo sù ba , shí jiān gèng zhòng yào .", japanese: "高速道路で行ってください。時間の方が重要です。" },
    { speaker: "B", chinese: "好的，到了，我会停在国际出发口。", pinyin: "Hǎo de , dào le , wǒ huì tíng zài guó jì chū fā kǒu .", japanese: "はい、ついてきました。国際線出発口に停めます。" }
    ],
    keyVocabulary: [
      { word: "师傅", pinyin: "shī fu", meaning: "運転手さん（タクシー・配車の呼称）", usageNote: "「师傅」是对司机/工匠的尊称，不是师父的师傅" },
      { word: "后备箱", pinyin: "hòu bèi xiāng", meaning: "トランク（車の後部荷物スペース）", writingNote: "中文「后备箱」= trunk。日文「トランク」（英借词）" },
      { word: "安全带", pinyin: "ān quán dài", meaning: "シートベルト", writingNote: "中文「安全带」= seat belt。日文「シートベルト」" },
      { word: "高峰", pinyin: "gāo fēng", meaning: "ピーク時", writingNote: "早高峰/晚高峰 = 朝のピーク/夕方のピーク" },
      { word: "高速费", pinyin: "gāo sù fèi", meaning: "高速道路料金", writingNote: "中国高速は距離制ではなく一定料金制" },
      { word: "出发口", pinyin: "chū fā kǒu", meaning: "出発口", writingNote: "国際線出国＝International Departures" },
      { word: "堵车", pinyin: "dǔ chē", meaning: "込む・渋滞", usageNote: "「堵」= 詰まる。堵车是中国大城市日常" },
      { word: "系好", pinyin: "jì hǎo", meaning: "締める", writingNote: "系好安全带 = シートベルトを締める（着実に締める）" }
    ],
  },
  {
    scene: "询问地铁站",
    ...
    sceneEmoji: "🚇",
    lines: [
    { speaker: "A", chinese: "你好，请问去国家博物馆在哪站换乘？", pinyin: "Nǐ hǎo , qǐng wèn qù Guójiā Bówùguǎn zài nǎ zhàn huàn chéng ?", japanese: "すみません、国立博物館に行くにはどこで乗り換えたらいいですか？" },
    { speaker: "B", chinese: "您需要在一号线换乘二号线，在王府井站下车。", pinyin: "Nín xū yào zài yī hào xiàn huàn chéng èr hào xiàn , zài Wángfǔjǐng zhàn xià chē .", japanese: "1号線で2号線に乗り換えて、王府井駅で降りてください。" },
    { speaker: "A", chinese: "王府井站是几号出口离博物馆最近？", pinyin: "Wángfǔjǐng zhàn shì jǐ hào chū kǒu lí bówùguǎn zuì jìn ?", japanese: "王府井駅はどの出口から博物館に一番近いですか？" },
    { speaker: "B", chinese: "从东出口出去，步行大约十分钟就到了。", pinyin: "Cóng dōng chū kǒu chū qù , bù xíng dà yuē shí fēn zhōng jiù dào le .", japanese: "東口から出て、歩いて約10分です。" },
    { speaker: "A", chinese: "好的，请问地铁票价是多少？", pinyin: "Hǎo de , qǐng wèn dì tiě piào jià shì duō shǎo ?", japanese: "はい、地下鉄の切符代はおいくらですか？" },
    { speaker: "B", chinese: "按里程计算，三站内三块钱，超过三站加一块。", pinyin: "Àn lí chéng jì suàn , sān zhàn nèi sān kuài qián , chāo guò sān zhàn jiā yí kuài .", japanese: "距離制で、3駅までは3元、3駅を超えると1元追加です。" },
    { speaker: "A", chinese: "请问交通卡可以充值吗？", pinyin: "Qǐng wèn jiāo tōng kǎ kě yǐ chōng zhí ma ?", japanese: "交通カードはチャージできますか？" },
    { speaker: "B", chinese: "可以在自助机上充值，也可以用手机扫码充值。", pinyin: "Kě yǐ zài zì zhù jī shàng chōng zhí , yě kě yǐ yòng shǒu jī sǎo mǎ chōng zhí .", japanese: "自動券売機でチャージできる他、スマホでQRコード決済も可能です。" },
    { speaker: "A", chinese: "好的，请问我要坐的这班车还有多久到？", pinyin: "Hǎo de , qǐng wèn wǒ yào zuò de zhè bān chē hái yǒu duō jiǔ dào ?", japanese: "はい、私が乗るこの電車はあとどのくらいで着きますか？" },
    { speaker: "B", chinese: "还有三分钟，下一班车马上就到，请抓紧时间。", pinyin: "Hái yǒu sān fēn zhōng , xià yì bān chē mǎ shàng jiù dào , qǐng zhuā jǐn shí jiān .", japanese: "あと3分です。下一本間もなく着きます。お急ぎください。" },
    { speaker: "A", chinese: "太感谢了！我先去买票，回头见。", pinyin: "Tài gǎn xiè le ! Wǒ xiān qù mǎi piào , huí tóu jiàn .", japanese: "どうもありがとう！先去きましてお会いしましょう。" },
    { speaker: "B", chinese: "不客气，祝您参观愉快。", pinyin: "Bú kè qi , zhù nín cān guān yú kuài .", japanese: "どういたしまして。博物館をお楽しみください。" }
    ],
    keyVocabulary: [
      { word: "换乘", pinyin: "huàn chéng", meaning: "乗り換える", writingNote: "中文「换乘」= transfer。日文「乗換」（同義漢語）" },
      { word: "交通卡", pinyin: "jiāo tōng kǎ", meaning: "交通ICカード（北京一卡通・上海交通卡等）", usageNote: "中国各大城市均有自己的交通卡：北京一卡通、上海交通卡、广州岭南通" },
      { word: "出口", pinyin: "chū kǒu", meaning: "出口", writingNote: "中日同形語（音読みほぼ同じ chū kǒu）" },
      { word: "地铁票价", pinyin: "dì tiě piào jià", meaning: "地下鉄料金", writingNote: "北京地铁：按公里计价，实行计程票制" },
      { word: "自助机", pinyin: "zì zhù jī", meaning: "自動券売機", writingNote: "中文「自助」= self-service。日文「セルフ」（英借词）" },
      { word: "里程", pinyin: "lǐ chéng", meaning: "距離・里程", writingNote: "中文「里程」= distance traveled。日文「里程」（同形同義）" },
      { word: "抓紧时间", pinyin: "zhuā jǐn shí jiān", meaning: "急ぐ・時間に追われる", usageNote: "「抓紧」= がっちり掴む。転じて「急ぐ」" },
      { word: "下车", pinyin: "xià chē", meaning: "降りる", writingNote: "中文「下车」= get off。日文「下车」（同形だが音読み）" }
    ],
  },
  {
    scene: "酒店入住",
    ...
    sceneEmoji: "🏨",
    lines: [
    { speaker: "A", chinese: "你好，我预订了今晚的房间，请帮我办理入住。", pinyin: "Nǐ hǎo , wǒ yù dìng le jīn wǎn de fáng jiān , qǐng bāng wǒ bàn lǐ rù zhù .", japanese: "こんばんは、今晚の部屋を予約してあるのですが、チェックインをお願いします。" },
    { speaker: "B", chinese: "好的，请问您贵姓？请问出示护照。", pinyin: "Hǎo de , qǐng wèn nín guì xìng ? Qǐng wèn chū shì hù zhào .", japanese: "はい、お名前をお聞かせいただけますか？パスポートも見せていただけますか？" },
    { speaker: "A", chinese: "我姓山本，护照给您，这是预订确认单。", pinyin: "Wǒ xìng Shān běn , hù zhào gěi nín , zhè shì yù dìng què rèn dān .", japanese: "山本です。パスポートと予約確認書です。" },
    { speaker: "B", chinese: "找到了，您订的是豪华双人房，住两晚。", pinyin: "Zhǎo dào le , nín dìng de shì háo huá shuāng rén fáng , zhù liǎng wǎn .", japanese: "確認できました。デラックスツイン、お二泊ですね。" },
    { speaker: "A", chinese: "是的，请问早餐包含在房费里吗？", pinyin: "Shì de , qǐng wèn zǎo cān bāo hán zài fáng fèi lǐ ma ?", japanese: "はい、朝食は部屋に含まれていますか？" },
    { speaker: "B", chinese: "包含的，早餐时间是早上七点到十点，这是早餐券。", pinyin: "Bāo hán de , zǎo cān shí jiān shì zǎo shàng qī diǎn dào shí diǎn , zhè shì zǎo cān quàn .", japanese: "含まれています。朝食時間は朝7時から10時までです。これが朝食券です。" },
    { speaker: "A", chinese: "好的，请问Wi-Fi密码是多少？", pinyin: "Hǎo de , qǐng wèn Wi-Fi mì mǎ shì duō shǎo ?", japanese: "はい、Wi-Fiのパスワードを教えてください。" },
    { speaker: "B", chinese: "密码在房卡套上，房间无线网络是Hotel-Free，无需密码。", pinyin: "Mì mǎ zài fáng kǎ tào shàng , fáng jiān wú xiàn wǎng luò shì Hotel-Free , wú xū mì mǎ .", japanese: "パスワードはカードスリーブに記載されています。客室のWi-Fiは「Hotel-Free」、パスワード不要です。" },
    { speaker: "A", chinese: "好的，请问需要交押金吗？", pinyin: "Hǎo de , qǐng wèn xū yào jiāo yā jīn ma ?", japanese: "はい、デポジット（押金）は必要ですか？" },
    { speaker: "B", chinese: "需要，刷一下信用卡作为押金，退房时会退还。", pinyin: "Xū yào , shuā yí xià xìn yòng kǎ zuò wéi yā jīn , tuì fáng shí huì tuì huán .", japanese: "必要です。クレジットカードでデポジットを押さえていただきます。退去時に返金いたします。" },
    { speaker: "A", chinese: "没问题，请问退房时间是几点？", pinyin: "Méi wèn tí , qǐng wèn tuì fáng shí jiān shì jǐ diǎn ?", japanese: "問題ありません。チェックアウトは何時ですか？" },
    { speaker: "B", chinese: "下午两点前退房都行，如果需要延迟请提前通知前台。", pinyin: "Xià wǔ liǎng diǎn qián tuì fáng dōu xíng , rú guǒ xū yào yán chí qǐng tí qián tōng zhī qián tái .", japanese: "午後2時までにチェックアウトしていただければ結構です。延長の場合は前台にご通知ください。" }
    ],
    keyVocabulary: [
      { word: "入住", pinyin: "rù zhù", meaning: "チェックイン", writingNote: "中文「入住」= 客室に入る。日文「チェックイン」" },
      { word: "预订确认单", pinyin: "yù dìng què rèn dān", meaning: "予約確認書", writingNote: "中文「确认单」= confirmation。日文「確認書」" },
      { word: "早餐券", pinyin: "zǎo cān quàn", meaning: "朝食券", writingNote: "中国星级酒店多以实体早餐券为主，部分为自助餐式" },
      { word: "Wi-Fi密码", pinyin: "Wi-Fi mì mǎ", meaning: "Wi-Fiパスワード", writingNote: "中国酒店Wi-Fi名多为酒店名拼音或英文，多需验证码" },
      { word: "押金", pinyin: "yā jīn", meaning: "デポジット（ 보증금 ）", usageNote: "中国酒店押金通常用信用卡预授权，退房即解冻" },
      { word: "信用卡", pinyin: "xìn yòng kǎ", meaning: "クレジットカード", writingNote: "中文「信用卡」= credit card。日文「クレジットカード」" },
      { word: "退房", pinyin: "tuì fáng", meaning: "チェックアウト", writingNote: "中文「退房」= 客室を退出する。日文「チェックアウト」" },
      { word: "前台", pinyin: "qián tái", meaning: "前台・フロント", writingNote: "中国酒店「前台」= reception。日文「フロント」" }
    ],
  }
]
